  ...
  if (tier === "free") return (
    <div style={{ minHeight: "100vh", background: theme.bg, color: theme.text, fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 560, margin: "80px auto", padding: "0 24px", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 15, color: theme.textMuted, marginBottom: 28, lineHeight: 1.7 }}>Diagnosis history is available on Pro and Expert plans. Upgrade to keep track of all your past diagnoses.</div>
